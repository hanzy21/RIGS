...
class MultiLoss(nn.Module):
    ...
    def forward(self, inputs):
        ...
        for loss_func in self.losses:
            ...
            if hasattr(loss_func, "last_components"):
                for name, component in loss_func.last_components.items():
                    loss_dict[f"{loss_func.__class__.__name__}.{name}"] = component.detach().item()
